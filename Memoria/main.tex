...
En algunos casos esto no es así, generalmente porque sus desarrolladores no se han dignado
a explorar los beneficios del paralelismo.
No obstante, el simple uso de varios hilos no implica una mejora en rendimiento,
...
la implementación es sencilla y no existe mucho sobrecoste.
Desafortunadamente esto no sucede en todos los algoritmos,
en esta investigación se analiza el algoritmo A*,
un claro ejemplo de cómo el paralelismo no siempre es
